  ...
  readJson(path.resolve(arg, 'package.json'), function (er, data) {
    ...
    if (er) {
      ...
      npm.commands.cache.add(dir, null, null, false, function (er, data) {
        ...
        chain(
          [
            [lifecycle, data, 'prepublishOnly', dir], [completedOne]
            [publish_, dir, data, isRetry, cached],
            [lifecycle, data, 'publish', dir], [completedOne]
            [lifecycle, data, 'postpublish', dir], [completedOne]
          ],
          cb
        )
      })
...
function publish_ (arg, data, isRetry, cached, progress, cb) {
